...
namespace MagistradosApp.Data
{
    public class Data_importe_tramite_excepcional_r : Data_importe_tramite_excepcional
    {
        ...
        public Data_importe_tramite_excepcional_r (DataInitMode mode) : base(mode)
        {
            Initialize(mode);
        }
        ...
        protected override void Initialize(DataInitMode mode = DataInitMode.Null)
        {
            ...
            switch(mode)
            {
                case DataInitMode.Default:
                    tramite_excepcional__id = (string?)ContainerApp.db.Values("tramite_excepcional").Default("id").Get("id");
                    tramite_excepcional__creado = (DateTime?)ContainerApp.db.Values("tramite_excepcional").Default("creado").Get("creado");
        ...
        public string? tramite_excepcional__Label { get; set; }

        protected string? _tramite_excepcional__id = null;
        public string? tramite_excepcional__id
        {
            get { return _tramite_excepcional__id; }
            set { _tramite_excepcional__id = value; _tramite_excepcional = value; NotifyPropertyChanged(); }
        }
        ...
        public string? persona__id
        {
            ...
            set { _persona__id = value; _tramite_excepcional__persona = value; NotifyPropertyChanged(); }
        }
        ...
        public string? sucursal__id
        {
            ...
            set { _sucursal__id = value; _tramite_excepcional__sucursal = value; NotifyPropertyChanged(); }
        }
        ...
        public string? departamento_judicial__id
        {
            ...
            set { _departamento_judicial__id = value; _tramite_excepcional__departamento_judicial = value; NotifyPropertyChanged(); }
        }
        ...
        public string? organo__id
        {
            ...
            set { _organo__id = value; _tramite_excepcional__organo = value; NotifyPropertyChanged(); }
        }
        ...
        public string? departamento_judicial_informado__id
        {
            ...
            set { _departamento_judicial_informado__id = value; _tramite_excepcional__departamento_judicial_informado = value; NotifyPropertyChanged(); }
        }
